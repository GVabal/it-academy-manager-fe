...
export const getStudentEditId = createSelector(getStudentsFeatureState, studentsState => studentsState.studentEditId || 0);
...
export const getSelectedStudentId = createSelector(getStudentsFeatureState, studentsState => studentsState.selectedStudentId || 0);
